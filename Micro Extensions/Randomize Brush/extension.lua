...
function init(plugin)
    plugin:newCommand{
        ...
        onclick = function()
            local sizeOption, angleOption, colorOption = Option.None,
                                                         Option.None,
                                                         Option.None
            ...
            local OnChange = function(ev)
                ...
                if sizeOption == Option.Grow or sizeOption == Option.Shrink then
                    ...
                    if sizeOption == Option.Grow then
                        size = size + variable
                    end
                    if sizeOption == Option.Shrink then
                        size = size - variable
                    end
                ...
                if sizeOption == Option.Random then
                    ...
                    toolPreferences.brush.size =
                        math.max(math.random(min, max), 1)
                end
                ...
                if angleOption == Option.Random then
                    ...
                    toolPreferences.brush.angle =
                        ((angleMin + math.random(0, d)) % 360) - 180
                end
            ...
            local onChangeListener = sprite.events:on('change', OnChange)
            ...
            :combobox{
                ...
                onchange = function()
                    ...
                    :modify{
                        ...
                        text = tostring(math.floor(
                                            toolPreferences.brush.size * 0.5))
                    } --
                    :modify{
                        id = "size-random-max",
                        visible = sizeOption == Option.Random,
                        text = tostring(math.ceil(
                                            toolPreferences.brush.size * 1.5))
                    } --
                    :modify{
                        id = "size-random-set",
            ...
            :combobox{
                ...
                label = "Option:",
                options = {
                    Option.None, Option.Rotate, Option.Random, Option.RandomSet
                },
                Option = angleOption,
                onchange = function()
                    ...
                    :modify{
                        ...
                        text = tostring(math.floor(
                                            toolPreferences.brush.angle * 0.5))
                    } --
                    :modify{
                        id = "angle-random-max",
                        visible = angleOption == Option.Random,
                        text = tostring(math.ceil(
                                            toolPreferences.brush.angle * 1.5))
                    } --
                    :modify{
                        id = "angle-random-set",
            ...
            :combobox{
                ...
                label = "Option:",
                options = {
                    Option.None, Option.Next, Option.Previous, Option.RandomSet
                },
                option = colorOption,
                onchange = function()
                    ...
                    :modify{
                        id = "color-range",
                        visible = colorOption ~= Option.None
                    } --
                    :modify{
                        id = "color-reset",
